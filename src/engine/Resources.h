...
#define RES_SHADER_VORONOI_FRAG	CINDER_RESOURCE( ../resources/shaders/, voronoi_frag.glsl, 134, GLSL )
#define RES_SHADER_RASTERIZER_FRAG	CINDER_RESOURCE( ../resources/shaders/, rasterizer_frag.glsl, 134, GLSL )
#define RES_SHADER_METAHEXBALLS_FRAG	CINDER_RESOURCE( ../resources/shaders/, metahexballs_frag.glsl, 134, GLSL )
#define RES_SHADER_TRIPPING_FRAG	CINDER_RESOURCE( ../resources/shaders/, tripping_frag.glsl, 134, GLSL )
#define RES_SHADER_CLOUD_FRAG	CINDER_RESOURCE( ../resources/shaders/, cloud_frag.glsl, 134, GLSL )
#define RES_SHADER_LIGHTGLOW_FRAG	CINDER_RESOURCE( ../resources/shaders/, lightglow_frag.glsl, 134, GLSL )
#define RES_SHADER_ENERGYFLICKER_FRAG	CINDER_RESOURCE( ../resources/shaders/, energyflicker_frag.glsl, 134, GLSL )
#define RES_SHADER_COSMOS_FRAG	CINDER_RESOURCE( ../resources/shaders/, cosmos_frag.glsl, 134, GLSL )
#define RES_SHADER_GLASSFIELD_FRAG	CINDER_RESOURCE( ../resources/shaders/, glassfield_frag.glsl, 134, GLSL )
#define RES_SHADER_INVERSION_FRAG	CINDER_RESOURCE( ../resources/shaders/, inversion_frag.glsl, 134, GLSL )
#define RES_SHADER_SHAPESHIFTER_FRAG	CINDER_RESOURCE( ../resources/shaders/, shapeshifter_frag.glsl, 134, GLSL )
#define RES_SHADER_STRIPES_FRAG	CINDER_RESOURCE( ../resources/shaders/, stripes_frag.glsl, 134, GLSL )
