...
#include "CoronaGlow.h"
#include "CoronaNebula.h"
...
class CoronaController {
  public:
	...
	void addGlows( const CoronaStar &star, float power, int amt );
	void addNebulas( const CoronaStar &star, int amt );
	void addDusts( const CoronaStar &star, int amt );
	...
	std::vector<CoronaGlow>     mGlows;
	std::vector<CoronaNebula>	mNebulas;
