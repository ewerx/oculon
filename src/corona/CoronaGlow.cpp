...
CoronaGlow::CoronaGlow( const Vec3f &pos, const Vec3f &vel, float radius, float lifespan )
{
	mPos		= pos;
	mVel		= vel;
	mRadiusDest	= radius;
...
void CoronaGlow::update( float dt )
{
...
void CoronaGlow::draw( const Vec3f &right, const Vec3f &up )
{
