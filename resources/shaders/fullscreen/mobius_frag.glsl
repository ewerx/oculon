...
float mobius(vec3 p, float b) {
	...
	return pow((2.0*zxy+xyy*(xy-zz+1.0))*(b-0.1)-xy*xy*(b2+0.2),2.0)-xy*pow(b*xy*0.2+(b2-0.2)*(zxy+xyy)-xy*(b+0.1)*(xy+zz+1.0),2.0);
}
